...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>🌟WELCOME🌟<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>👑TRUONG HUB👑<Color=/>"):Display()
    wait(.14)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Truong Hub", HidePremium = false, IntroText = "Truong Library🔩", SaveConfig = true, ConfigFolder = "Truong Hub"})
...
W:AddLabel("Script By VietTruong👑")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Truong Hub NEW SCRIPT!")
W:AddLabel("[+] I IM VietTruongg!")
W:AddLabel("[+] 👑!!!")
